  ...
  public class MqQueueHelper : IMessageBrokerHelper
  {
    ...
    public void QueueMessage(string messageText)
    {
      ...
      using (var channel = connection.CreateModel())
      {
        ...
        var message = JsonConvert.SerializeObject(messageText);//"This message came from other side of universe";
        var body = Encoding.UTF8.GetBytes(message);

        channel.BasicPublish(exchange: "", routingKey: "OASQueue", basicProperties: null, body: body);
      }
    }
  }
}
